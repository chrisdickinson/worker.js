;(function() {
  ...
  StubbedURL.fallbackLocalStorage = function(file) {

  }

  StubbedURL.createObjectURL = function(file) {
  ...
  var worker = function(fn) {
    var str = fn.toString()
      ...
      , ret = function() {
          ...
          webworker.worker.postMessage(args)
          return {
      ...
      function create_webworker () {
        ...
        function(msg) {
          // async version
          var ready = function() {
            postMessage({channel:'output', data:arguments.length === 1 ? arguments[0] : [].slice.call(arguments)})
          }

          __target__.apply(this, msg.data.concat([ready]))
        } :      
        function(msg) {
          // sync version
          postMessage({channel:'output', data:__target__.apply(this, msg.data)})
        })+';\n')
